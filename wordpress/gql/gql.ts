...
type Documents = {
    ...
    "query GetAllPosts($first: Int!, $after: String, $where: RootQueryToPostConnectionWhereArgs) {\n  categories(first: 5, where: {orderby: COUNT, order: DESC}) {\n    nodes {\n      id\n      databaseId\n      name\n      slug\n      count\n    }\n  }\n  tags {\n    nodes {\n      id\n      name\n      slug\n    }\n  }\n  posts(first: $first, after: $after, where: $where) {\n    pageInfo {\n      hasNextPage\n      endCursor\n    }\n    nodes {\n      ...PostCardFields\n      status\n    }\n  }\n}": typeof types.GetAllPostsDocument,
    "query PostsByModified($first: Int!, $after: String, $afterYear: Int!, $afterMonth: Int!, $afterDay: Int!) {\n  posts(\n    first: $first\n    after: $after\n    where: {orderby: {field: MODIFIED, order: ASC}, dateQuery: {inclusive: true, after: {year: $afterYear, month: $afterMonth, day: $afterDay}}, status: PUBLISH}\n  ) {\n    pageInfo {\n      endCursor\n      hasNextPage\n    }\n    nodes {\n      databaseId\n      slug\n      title\n      date\n      modified\n      status\n      link\n      featuredImage {\n        node {\n          sourceUrl\n        }\n      }\n      categories {\n        nodes {\n          slug\n          name\n        }\n      }\n      tags {\n        nodes {\n          slug\n          name\n        }\n      }\n      excerpt\n      content\n    }\n  }\n}": typeof types.PostsByModifiedDocument,
 ...
 * The graphql function is used to parse GraphQL queries into a document that can be used by GraphQL clients.
 */
export function graphql(source: "query PostsByModified($first: Int!, $after: String, $afterYear: Int!, $afterMonth: Int!, $afterDay: Int!) {\n  posts(\n    first: $first\n    after: $after\n    where: {orderby: {field: MODIFIED, order: ASC}, dateQuery: {inclusive: true, after: {year: $afterYear, month: $afterMonth, day: $afterDay}}, status: PUBLISH}\n  ) {\n    pageInfo {\n      endCursor\n      hasNextPage\n    }\n    nodes {\n      databaseId\n      slug\n      title\n      date\n      modified\n      status\n      link\n      featuredImage {\n        node {\n          sourceUrl\n        }\n      }\n      categories {\n        nodes {\n          slug\n          name\n        }\n      }\n      tags {\n        nodes {\n          slug\n          name\n        }\n      }\n      excerpt\n      content\n    }\n  }\n}"): (typeof documents)["query PostsByModified($first: Int!, $after: String, $afterYear: Int!, $afterMonth: Int!, $afterDay: Int!) {\n  posts(\n    first: $first\n    after: $after\n    where: {orderby: {field: MODIFIED, order: ASC}, dateQuery: {inclusive: true, after: {year: $afterYear, month: $afterMonth, day: $afterDay}}, status: PUBLISH}\n  ) {\n    pageInfo {\n      endCursor\n      hasNextPage\n    }\n    nodes {\n      databaseId\n      slug\n      title\n      date\n      modified\n      status\n      link\n      featuredImage {\n        node {\n          sourceUrl\n        }\n      }\n      categories {\n        nodes {\n          slug\n          name\n        }\n      }\n      tags {\n        nodes {\n          slug\n          name\n        }\n      }\n      excerpt\n      content\n    }\n  }\n}"];
/**
 * The graphql function is used to parse GraphQL queries into a document that can be used by GraphQL clients.
 */
